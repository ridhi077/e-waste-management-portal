...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">ARUN</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="../index.html"><span><b> WMS</b> </span></a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Better Solutions For The Waste In Your Home</h1>
          <h2>Keep our Home Healthy</h2>
  ...
  <main id="main">
    ...
    <!--form section started for the product detail-->
    <div class="container">
      <div class="row">
        <div class="col-md-4 offset-md-4 form">
          <form action="index.php" method="POST" autocomplete="">
            ...
            <div class="form-group">
              <input class="form-control" type="number" name="address" placeholder="Pin Code" required>
            </div>
            <label for Waste> choose your waste</label>
            <select id="Waste">
              
      
              <option value="Paper">Paper material</option>
              <option value="Plastics">Plastics</option>
              <option value="metal">metal</option>
              <option value="Glass">Glass Material</option>
              <option value="ewaste">E-waste</option>
              <option value="bwaste">Battery Waste</option>
              <option value="other">other</option>
              
            </select>
            <div class="form-group">
              <input class="form-control" type="number" name="address" placeholder="Amount of the Waste in KG" required>
            </div>

            <div class="form-group">
              <input class="form-control" type="file"  name="image" placeholder="choose image" width="48" height="48" required>
            </div>
    ...
    <!--form section end for the product detail-->
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          ...
          <!-- determine the rate of the waste-->
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
            ...
            <div class="skills-content">
              ...
              <div class="progress">
                <span class="skill">Glass Waste<i class="val">25%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">E-waste Waste<i class="val">20%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">Battery Waste<i class="val">45%</i></span>
                <div class="progress-bar-wrap">
                  <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              IKGPTU <br>
              Kapurthala, Punjab state<br>
              India <br><br>
              <strong>Phone:</strong> +91 9852312351<br>
              <strong>Email:</strong> <a href="mailto:raushanbharti12345@gmail.com">raushanbharti12345@gmail.com<br></a>
            </p>
          </div>
    ...
    <div class="container footer-bottom clearfix">
      ...
      <div class="credits">
        Designed by <a href="">Raushan</a> and <a href="">The Savants</a>
      </div>
    </div>
  </footer><!-- End Footer -->
